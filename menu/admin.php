<div class="menu_section">
  <h3>General</h3>
    <ul class="nav side-menu">
      <li><a href="main.php?module=home_admin"><i class="fa fa-home"></i> Home </a>
      </li>
          ...
          <ul class="nav child_menu">
            <li><a><i class="fa fa-user"></i> User <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
                ...
                <li><a href="main.php?module=user"><i class="fa fa-key"></i> Akun User </a></li>
              </ul>
            </li>
            ...
            <li><a><i class="fa fa-warning"></i> Pelanggaran <span class="fa fa-chevron-down"></span></a>
              <ul class="nav child_menu">
                ...
                <li><a href="main.php?module=tindakan">Tindakan</a></li>
              </ul>
            </li>
            <li><a href="main.php?module=prestasi"><i class="fa fa-star-o"></i> Prestasi</a>
            </li>
            <li><a href="main.php?module=alumni"><i class="fa fa-users"></i> Data Alumni </a>
            </li>
            <li><a href="main.php?module=siswa_keluar"><i class="fa fa-users"></i> Siswa Keluar / Pindah </a>
            </li>  
          </ul>
      </li>
    </ul>
...
<div class="menu_section">
  <h3>Pembinaan Karakter</h3>
    <ul class="nav side-menu">
      <li><a href="main.php?module=input_prestasi_siswa"><i class="fa fa-pencil-square-o"></i> Input Prestasi Siswa </a>
      </li>
      <li><a href="main.php?module=input_pelanggaran_siswa"><i class="fa fa-pencil-square-o"></i> Input Pelanggaran Siswa </a>
      </li>
