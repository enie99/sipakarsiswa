                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        $poin_pelanggaran=mysqli_query($connect, "SELECT SUM(pelanggaran.poin) AS jml FROM detail_poin JOIN pelanggaran ON detail_poin.id_pelanggaran=pelanggaran.id_pelanggaran WHERE detail_poin.nis='$nis'");
                        $pp=mysqli_fetch_array($poin_pelanggaran);
                        $totPoin=$pp['jml'];
