        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Tambah Data Prestasi</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="module/prestasi_siswa/aksi_simpan.php" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="prestasi" id="autocomplete-prestasi" class="form-control col-md-10" style="float: left;" required="required" />
                          <div id="autocomplete-container" style="position: relative; float: left; width: 400px; margin: 10px;"></div>
                        </div>
                      </div>
                ...
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
                        $prestasi=mysqli_query($connect, "SELECT * FROM detail_poin JOIN siswa ON detail_poin.nis=siswa.nis JOIN prestasi ON detail_poin.id_prestasi=prestasi.id_prestasi WHERE tahun_ajaran='$thAjaran' ORDER BY tanggal DESC");
                        $no=1;
                        while($plg=mysqli_fetch_array($prestasi)){
                        $idDetailPoin=$plg['id_detail_poin'];
                         ?>
                        <tr>
                          <td><?php echo $no; ?></td>
                          <td><?php echo $plg['tanggal']; ?></td>
                          <td><a href="main.php?module=detail_siswa&nis=<?php echo $plg['nis'];?>&sb=input_prestasi"><?php echo $plg['nis']; ?></a></td>
                          <td><a href="main.php?module=detail_siswa&nis=<?php echo $plg['nis'];?>&sb=input_prestasi"><?php echo $plg['nama_siswa']; ?></a></td>
                          <td><?php echo $plg['nama_prestasi']; ?></td>
                          <td>
                            <div class="btn-group">
