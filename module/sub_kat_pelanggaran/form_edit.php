          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Edit Sub Kategori Pelanggaran<small></small></h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="module/sub_kat_pelanggaran/aksi_edit.php" method="post">
                      <?php
                        $idSubKategori=$_GET['id_sub_kategori'];
                        $sub_kategori=mysqli_query($connect,"SELECT * FROM sub_kat_pelanggaran WHERE id_sub_kategori='$idSubKategori'");
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="hidden" name="idSubKategori" value="<?php echo $idSubKategori; ?>">
                          <input type="text" id="subKatPelanggaran" name="subKatPelanggaran" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $namaSubKategori; ?>">
                        </div>
                      </div>
