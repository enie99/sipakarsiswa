          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3> Tambah Data Prestasi<small></small></h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="module/prestasi/aksi_simpan.php" method="post">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Nama Prestasi <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="namaPrestasi" name="namaPrestasi" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
