          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3> Tambah Data Orang Tua<small></small></h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Tambah Data Orang Tua</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="module/ortu/aksi_simpan.php" method="post">

                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Nama Orang Tua <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="namaOrtu" name="namaOrtu" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="noHp" name="noHp" required="required" class="form-control col-md-7 col-xs-12" maxlength="12" data-validate-length-range="10,12">
                        </div>
                      </div>
                      <div class="item form-group">
