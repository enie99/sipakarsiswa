          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Master Data Jenis Pelanggaran<small></small></h3>
              </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Tambah Jenis Pelanggaran</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="module/pelanggaran/aksi_simpan.php" method="post">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Sub Kategori Pelanggaran</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="subKatPelanggaran" class="form-control" required="required">
                            ...
                            <?php
                              ...
                              while ($sub=mysqli_fetch_array($sub_kat_pelanggaran)) {
                             ?>
                            <option value="<?php echo $kat['id_sub_kategori']; ?>"><?php echo $sub['nama_sub_kategori']; ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
